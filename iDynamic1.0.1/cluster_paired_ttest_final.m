function [sumt_negative, time_negative,t_max_n,sumt_positive, time_positive,t_max_p, t_max, z_n,z_p,time_negative2,time_positive2]= cluster_paired_ttest_final(data_wd,n1,n2,bootnum,p_value)
...
for j=1:bootnum
	...
	data_wdb=sortrows(data_wdb,1:2);
	data_wdb(:,1:2)=[];
